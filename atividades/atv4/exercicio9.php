      ...
      <h1>Exercicio 9</h1>
        ...
        <?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                $frase = $_POST['frase'];
                $fraseSemEspacoInicioEFim = trim($frase);
                $fraseSemEspaco = str_replace(" ", "", $frase);

                echo "<p>Frase original: $frase</p></br>";
                echo "<p>Frase Sem espaços no inicio e fim: $fraseSemEspacoInicioEFim</p></br>";
                echo "<p>Frase com todos os espaços removidos: $fraseSemEspaco</p></br>";
            }
        ?>
