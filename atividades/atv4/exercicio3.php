      ...
      <h1>Exercicio 3</h1>
        ...
        <?php
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                $contains = str_contains($palavra1, $palavra2);

                if ($contains) {
                    echo "<p>A palavra $palavra2 está contida na $palavra1!</p>";
                } else {
                    echo "<p>A palavra $palavra2 <strong>NÃO</strong> está contida na $palavra1!</p>";
                }
            }
        ?>
